                ...
                AlertDialog.Builder msgBuilder = new AlertDialog.Builder(mContext)
                        ...
                        .setPositiveButton("네", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                String dbPath = "/data/data" + "/com.mentenseoul.todaylottoking" + "/databases/database5";
                                SQLiteDatabase database = SQLiteDatabase.openDatabase(dbPath,null, SQLiteDatabase.OPEN_READWRITE );

                                int _num = holder.getAdapterPosition();
                                database.execSQL("delete from " + "table5" + " where _id = " + _id);
