...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder>{
    ...
    String tableName;
    List<com.mentenseoul.todaylottoking.Ball> list;

    Context context;

    public DataAdapter(List<com.mentenseoul.todaylottoking.Ball> list){
        this.list = list;
    }
    ...
    private void insertRecord(int num) {
        int _num = num;
        com.mentenseoul.todaylottoking.Ball getBall = list.get(_num);
