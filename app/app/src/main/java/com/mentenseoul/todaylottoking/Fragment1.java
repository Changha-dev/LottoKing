...
public class Fragment1 extends Fragment {
    ...
    com.mentenseoul.todaylottoking.DataAdapter dataAdapter;

    List<com.mentenseoul.todaylottoking.Ball> list = new ArrayList<>();
    @Override
...
//        list = new ArrayList<>();
        ...
        dataAdapter = new com.mentenseoul.todaylottoking.DataAdapter(list);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                com.mentenseoul.todaylottoking.Ball setBall =  new com.mentenseoul.todaylottoking.Ball(tmpId1, tmpId2, tmpId3, tmpId4, tmpId5, tmpId6);
